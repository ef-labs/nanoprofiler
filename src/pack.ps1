...
.nuget/nuget pack NanoProfiler.Core\NanoProfiler.Core.csproj -Prop Configuration=Release -Sym
...
.nuget/nuget pack NanoProfiler.Unity\NanoProfiler.Unity.csproj -Prop Configuration=Release -Sym
